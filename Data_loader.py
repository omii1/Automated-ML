...
class load_Data:
    ...
    def __inti__(self,file_object,logger_object):
    self.training_data = "Data_Collection".self
    self.file_object = file_object
    self.logger_object = logger_object


    def load_data(self):
     self.logger_object.log(self.file_object, 'Entered the get_data method of the load_data class')
     try:
         self.data = pd.read_csv(self.tranining_data)
